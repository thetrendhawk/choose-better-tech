...
export const featuredReviews: ArticlePreview[] = [
  { key: "privacy-bee-review", title: "Privacy Bee Review", excerpt: "A hands-on review of Privacy Bee's broad privacy workflows, monitoring, Identity Vault, Search Presence, human support, and removal-proof limits.", href: "/reviews/privacy-bee-review", status: "Published Review" },
...
export const featuredGuides: ArticlePreview[] = [
  ...
  { key: "are-password-managers-safe", title: "Are Password Managers Safe?", excerpt: "A skeptical security guide to password-manager vaults, breaches, zero knowledge, master passwords, MFA, autofill, passkeys, recovery, and safer setup.", href: "/are-password-managers-safe", status: "Published Guide" },
  { key: "password-manager-vs-browser-passwords", title: "Password Manager vs Browser Passwords", excerpt: "A practical comparison of browser and operating-system password managers against dedicated password managers by security, passkeys, sharing, recovery, portability, privacy, and ease of use.", href: "/password-manager-vs-browser-passwords", status: "Published Guide" },
  { key: "best-password-managers-for-families", title: "Best Password Managers for Families", excerpt: "A family-focused guide to shared vaults, private vaults, recovery, emergency access, child and teen boundaries, offboarding, and long-term family-plan value.", href: "/best-password-managers-for-families", status: "Published Guide" },
  { key: "best-password-managers-for-privacy", title: "Best Password Managers for Privacy", excerpt: "A privacy-first comparison of encrypted metadata, aliases, open-source evidence, audits, telemetry, account data, and portability.", href: "/best-password-managers-for-privacy", status: "Published Guide" },
  { key: "how-password-managers-work", title: "How Password Managers Actually Work", excerpt: "A plain-English guide to key derivation, local encryption, cloud sync, autofill, sharing, recovery, passkeys, and exports.", href: "/guides/how-password-managers-work", status: "Published Guide" },
  ...
  { key: "best-free-vpns", title: "Best Free VPNs", excerpt: "A skeptical comparison of legitimate free VPN tiers by data limits, locations, privacy, devices, streaming, and upgrade pressure.", href: "/best-free-vpns", status: "Published Guide" },
  { key: "best-vpns-for-students", title: "Best VPNs for Students", excerpt: "A student-focused VPN guide for budgets, campus Wi-Fi, free plans, devices, streaming, privacy, and study abroad.", href: "/best-vpns-for-students", status: "Published Guide" },
  { key: "best-vpns-for-travel", title: "Best VPNs for Travel", excerpt: "A travel-focused VPN guide for public Wi-Fi, international trips, many devices, streaming abroad, restrictive networks, and short-term plans.", href: "/best-vpns-for-travel", status: "Published Guide" },
...
export const featuredComparisons: ArticlePreview[] = [
  ...
  {
    key: "bitwarden-vs-1password",
    title: "Bitwarden vs 1Password",
    excerpt: "An evidence-based comparison of free-plan value, premium polish, family workflows, transparency, self-hosting, recovery, and Travel Mode.",
