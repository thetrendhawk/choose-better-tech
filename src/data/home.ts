...
export const featuredGuides: ArticlePreview[] = [
  { key: "windows-defender-vs-paid-antivirus", title: "Windows Defender vs Paid Antivirus", excerpt: "A capability-gap guide to when Windows 11's built-in protection is enough and when a paid suite solves a concrete household, platform, support, or bundle need.", href: "/guides/windows-defender-vs-paid-antivirus", status: "Published Guide" },
