...
export const reviewGroups: ArticleGroup[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      { key: "deleteme-review", title: "DeleteMe Review", excerpt: "A beginner-focused review of DeleteMe's human-assisted data broker removal, reporting, independent evidence, privacy tradeoffs, and limits.", href: "/reviews/deleteme-review", status: "Published Review" },
      { key: "privacy-bee-review", title: "Privacy Bee Review", excerpt: "A hands-on review of Privacy Bee's broad privacy workflows, monitoring, Search Presence, Identity Vault, support, pricing, and removal-proof limits.", href: "/reviews/privacy-bee-review", status: "Published Review" }
    ]
  }
];
