...
export const nordVpnReview: ReviewPageContent = {
  ...
  relatedGuides: [
    ...
    { title: "Best VPNs for Families", href: "/best-vpns-for-families", description: "Compare household VPN choices by device limits, shared accounts, routers, smart TVs, privacy, and family travel." },
