...
import { incogniVsOpteryComparison as comparison } from "../data/comparisons/incogniVsOptery";
...
export function IncogniVsOpteryPage() {
    ...
    <>
      ...
      <Section className="bg-slate-50" id="decision-table">
        <SectionHeading
          ...
          description="This is not a universal winner table. It is a reader-fit comparison based on the approved Incogni and Optery research repositories."
        />
      ...
      <Section>
        <article id="final-verdict" className="scroll-mt-24 rounded-lg border border-slate-200 bg-white p-6 shadow-soft">
          ...
          <p className="mt-4 text-base leading-8 text-slate-700">
            Incogni is the better fit for most hands-off beginners, users who want simpler recurring broker-removal automation, broader geographic availability, and Deloitte process assurance. Optery is the better fit for users who want screenshot proof, people-search exposure visibility, a free scan/report entry point, and stronger documentation of what was found and what changed. Neither service deletes someone from the internet, guarantees permanent removal, or replaces broader safety, legal, or professional support for high-risk situations.
          </p>
        </article>
      </Section>
