...
import { bitwardenVsNordPassComparison as comparison } from "../data/comparisons/bitwardenVsNordPass";
...
export function BitwardenVsNordPassPage() {
  ...
  return (
    <>
      <SEO
        ...
        description="An evidence-based Bitwarden vs NordPass comparison covering free plans, mainstream simplicity, transparency, self-hosting, Nord ecosystem fit, security, and business fit."
      ...
      <Section className="bg-slate-50" id="decision-table">
        <SectionHeading
          ...
          description="This is not a universal winner table. It is a reader-fit table based on the approved Bitwarden and NordPass research repositories."
        />
      ...
      <Section>
        <article id="final-verdict" className="scroll-mt-24 rounded-lg border border-slate-200 bg-white p-6 shadow-soft">
          ...
          <p className="mt-4 text-base leading-8 text-slate-700">
            Bitwarden is the stronger reader-fit choice for free-plan seekers, open-source/transparency-minded users, self-hosting users, technical users, value-conscious buyers, and businesses that want admin depth or optional self-hosting. NordPass is the stronger reader-fit choice for users who want a simpler mainstream commercial experience, Nord ecosystem fit, value-oriented paid plans, and less technical setup. 1Password remains the stronger alternative for premium polish, family workflows, recovery and sharing maturity, and Travel Mode, while Proton Pass remains the stronger alternative for privacy ecosystem users, aliases/email privacy, and Swiss privacy framing.
          </p>
        </article>
      </Section>
