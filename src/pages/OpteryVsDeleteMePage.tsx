...
import { opteryVsDeleteMeComparison as comparison } from "../data/comparisons/opteryVsDeleteMe";
...
export function OpteryVsDeleteMePage() {
    ...
    <>
      ...
      <Section className="bg-slate-50" id="decision-table">
        <SectionHeading
          ...
          description="This is not a universal winner table. It is a reader-fit comparison based on the approved Optery and DeleteMe research repositories."
        />
