...
const faqItems = [
  ...
  },
  {
    ...
    answer: "A browser password manager is better than reusing passwords, and it can be enough for simple one-ecosystem use. A dedicated password manager is usually stronger when you need cross-browser use, family sharing, emergency planning, stronger reporting, or a clearer account-recovery workflow."
  },
  {
