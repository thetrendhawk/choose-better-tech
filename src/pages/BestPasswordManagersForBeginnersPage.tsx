      ...
      <Section>
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-2">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-soft">
            ...
            <p className="mt-5 text-sm leading-6 text-slate-600">For the deeper security model, read <Link className="font-semibold text-brand-700 hover:text-brand-800" to="/are-password-managers-safe">Are Password Managers Safe?</Link></p>
          </div>
        </div>
      </Section>
