...
| `/comparisons/incogni-vs-deleteme` | Comparison | High | Self-canonical | Included | Verified indexed; search participation | UNKNOWN | 2026-07-19 | GSC URL Inspection/Performance | Recheck monthly | 0 clicks, 0 impressions? URL-level indexing confirmed; no unsupported query claim |
| `/comparisons/optery-vs-deleteme` | Comparison | High | Self-canonical | Included | Verified indexed; search participation | UNKNOWN | 2026-07-19 | GSC URL Inspection/Performance | Recheck monthly | URL-level indexing confirmed |
| `/comparisons/incogni-vs-optery` | Comparison | High | Self-canonical | Included | Verified indexed; search participation | UNKNOWN | 2026-07-19 | GSC URL Inspection/Performance | Recheck monthly | URL-level indexing confirmed |
